        ...
        <div className="w-full max-w-2xl mx-auto pt-10 px-4 sm:px-6 lg:px-8" >
            ...
            <div className="grow space-y-1" >
              ...
              <p className="text-xs text-gray-500 dark:text-neutral-400">
                <span className="font-medium">
                  TypeScript · React · Node.js · Express · MongoDB · Node ·
                  MongoDB · MongoDB
                </span>
              </p>
            </div>
          ...
          <div className="mt-8">
            <p className="text-sm text-gray-600 dark:text-neutral-400">
              I am a dedicated full stack developer with over 3 years of
              experience in building robust, scalable, and user-friendly web
              applications. My expertise lies in software development and modern web
            ...
            <p className="mt-3 text-sm text-gray-600 dark:text-neutral-400">
              ...
              projects, including a fintech digital wallet serving over 500K
              users, a remittance application, and various management systems. I
              am passionate about creating efficient, maintainable, and
              innovative solutions that drive real-world results.
            </p>

           <ul className="mt-5 flex flex-col gap-y-3">
  <li className="flex items-center gap-x-2.5">
    <Mail className="w-4 h-4 text-gray-500 dark:text-neutral-500" />
    <a
      className="text-sm text-gray-500 hover:text-gray-800 hover:underline hover:decoration-2 focus:outline-hidden dark:text-neutral-500 dark:hover:text-neutral-400"
      href="mailto:ayushnir18@gmail.com"
    >
      ayushnir18@gmail.com
    </a>
  </li>

  <li className="flex items-center gap-x-2.5">
    <Instagram className="w-4 h-4 text-gray-500 dark:text-neutral-500"/>
    <a
      className="text-sm text-gray-500 hover:text-gray-800 hover:underline hover:decoration-2 focus:outline-hidden dark:text-neutral-500 dark:hover:text-neutral-400"
    ...
    >
      @the.ayush.niraula
          ...
          <div className="mt-10 sm:mt-14" id="experience">
            <h2 className="mb-5 font-medium text-gray-800 dark:text-neutral-200">
              Work experience
            </h2>
